...
* @ind: Starting index of a number in the buffer @buffer: Array of chars
* @flags: Flags specifiers @width: The width specifier
...
int flags, int width, int precision, int size)
{
	...
	char padd = ' ';
UNUSED(is_negative), UNUSED(size);
...
return (write(1, &buffer[ind], length)); }
/**
* write_pointer - function to write a memory address  @buffer: Arrays of chars
* @ind: Starting index of a number in the buffer @length: The length of number
* @width: The width specifier @flags: Flags specifier
...
{
if (extra_c)
buffer[--padd_start] = extra_c, buffer[1] = '0', buffer[2] = 'x';
